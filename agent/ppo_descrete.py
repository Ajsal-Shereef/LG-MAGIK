...
class MLPActor(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.shared_mlp = MLP(self.input_dim, kwargs["shared_fc_out_dim"], kwargs["shared_fc_hidden_sizes"], kwargs["shared_fc_hidden_activation"], norm="none")
        
        # Layer for the mean of the action distribution
        self.q_layer = Linear(kwargs["shared_fc_out_dim"], self.action_dim, norm="none")
...
class MLPCritic(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.net = MLP(kwargs["input_dim"], 1, kwargs["shared_fc_hidden_sizes"], kwargs["shared_fc_hidden_activation"], norm="none")
...
class PPO(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        if self.observation_mode == 'image':
            ...
            self.critic = MLPCritic(**kwargs).to(device)
    ...
    def set_training_params(self, config, train_transform):
        ...
        self.target_kl = config.get("target_kl", None)  # e.g. 0.03
    ...
    def learn(self, timestep):
        ...
        # bookkeeping for KL early stopping
        do_early_stop = False
        approx_kl = None
        ...
        for _ in range(self.epochs):
            ...
            for start in range(0, len(rewards), self.batch_size):
                ...
                with torch.no_grad():
                    ...
                    mb_approx_kl = (old_logprobs[mb_indices] - new_logprobs).mean().item()
